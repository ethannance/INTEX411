...
namespace AuthLab2.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(int pageNum = 1, string? productType = null, int pageSize = 5/*, productColor = null*/)
        {
            ...
            var allProducts = _repo.Products
                .Where(x => productType == null || x.category == productType)/* && (x => productColor == null || x.primary_color == productColor))*/
                .OrderBy(x => x.name)
